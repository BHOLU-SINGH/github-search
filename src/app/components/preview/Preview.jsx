...
export default function Preview({ data, status, isLoading }) {
  ...
  const openReposList = () => {
    ...
    setListUrl(data.repos_url);
    setCount(1);
  };
  const openFollowingList = () => {
    setHandleListCard(true);
    setListUrl(data.following_url?.split("{")[0]);
    setCount(2);
  };
  const openFollowersList = () => {
    setHandleListCard(true);
    setListUrl(data.followers_url);
    setCount(3);
  };
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-row gap-10 items-center">
              ...
              <div>
                ...
                <p className="text-slate-400">Joined at {data.created_at?.split("T")[0]}</p>
              </div>
            </div>
            <div>
            ...
            <div className="flex gap-5 justify-start flex-col flex-wrap">
              <div className="flex gap-5 justify-start flex-wrap">
                <div className="flex gap-5 items-center">
                  ...
                  <span className="text-slate-300">{data.location ? data.location : "Not Found"}</span>
                </div>
                <div className="flex gap-5 items-center">
                  <span>
                    <svg
              ...
              <div className="flex gap-5 justify-start flex-wrap">
                <div className="flex gap-5 items-center">
                  ...
                  <span>
                    {data.blog ? (
                      <Link className="text-slate-300" href={data.blog} target="_blank">
                        {data.blog}
                      </Link>
                    ) : (
                      "Not Found"
                ...
                <div className="flex gap-5 items-center">
                  ...
                  <Link className="text-slate-300" href={`mailto:${data.email ? data.email : ""}`}>
